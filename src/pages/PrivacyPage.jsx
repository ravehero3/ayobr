...
export default function PrivacyPage() {
  ...
  const sections = [
    { id: 's1', title: t('privacy.s1.title'), desc: t('privacy.s1.desc') },
    { id: 's2', title: t('privacy.s2.title'), desc: t('privacy.s2.desc') },
    { id: 's3', title: t('privacy.s3.title'), desc: t('privacy.s3.desc') },
    { id: 's4', title: t('privacy.s4.title'), desc: t('privacy.s4.desc') },
    { id: 's5', title: t('privacy.s5.title'), desc: t('privacy.s5.desc') },
    { id: 's6', title: t('privacy.s6.title'), desc: t('privacy.s6.desc') },
    { id: 's7', title: t('privacy.s7.title'), desc: t('privacy.s7.desc') }
  ];
