...
export default function LoginPage() {
  ...
  // Rights agreement screen (shown after login if user hasn't agreed yet)
  if (showRights && user) {
    return (
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="rounded-2xl border border-white/10 p-8" style={{ background: 'rgba(255,255,255,0.03)' }}>
          ...
          <button onClick={login}
            className="w-full py-3 rounded-xl font-semibold text-lg transition-all hover:scale-105 mb-4"
