        ...
        <AnimatePresence>
          {(() => {
            ...
            <motion.div
              ...
              className="fixed inset-0 flex flex-col items-center justify-center text-center bg-black/20"
              style={{ zIndex: 50 }}
            >
              <div className="inline-flex items-center justify-center w-24 h-24 mb-6 rounded-full bg-blue-400/20 border-2 border-dashed border-blue-400/50">
