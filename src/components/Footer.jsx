    ...
    >
      ...
      >
        ...
        <div className="flex items-center space-x-6">
          {/* Ready counter */}
          <div className="flex items-center space-x-2" style={{ marginLeft: '-100px' }}>
        ...
        <div className="absolute" style={{ left: 'calc(50% + 92px + 8px - 100px + 20px)', top: '50%', transform: 'translateY(-50%)' }}>
