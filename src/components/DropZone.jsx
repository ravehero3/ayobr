      ...
      <div className="relative text-center space-y-6 w-full flex flex-col items-center justify-center" style={{ zIndex: 60 }}>
        ...
        >
          ...
          <div className="flex items-center gap-3 px-16 py-2 bg-space-gray/30 rounded-full border border-neon-blue/20 group-hover:border-neon-blue/30 transition-all duration-300">
            ...
            <span className="text-xs font-medium text-gray-300" style={{ marginLeft: '-6px' }}>MP3, <span style={{ marginLeft: '-2px' }}>WAV</span></span>
          </div>
          ...
          <div className="flex items-center gap-3 px-16 py-2 bg-space-gray/30 rounded-full border border-neon-purple/20 group-hover:border-neon-purple/30 transition-all duration-300">
            ...
            <span className="text-xs font-medium text-gray-300" style={{ marginLeft: '-6px' }}>PNG, <span style={{ marginLeft: '-2px' }}>JPG</span></span>
          </div>
        </motion.div>
