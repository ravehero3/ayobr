    ...
    >
      {image ? (
        ...
        <div className="flex flex-col items-center justify-center h-full relative z-10">
          ...
          <p className="text-xs text-white/70 font-light text-center drop-shadow-sm px-6 py-1 rounded-full bg-white/5 backdrop-blur-sm" style={{ marginLeft: '-2px' }}>PNG, JPG, HEIC</p>
        </div>
      )}
    </motion.div>
  );
