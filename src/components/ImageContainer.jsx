    ...
    >
      ...
      {image ? (
          ...
          <div className="flex items-center justify-between mb-4 relative" style={{ marginTop: '-2px' }}>
            ...
            {isHovered && image && onStartImageDrag && (
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.boxShadow = '0 0 10px rgba(255,255,255,0.45)'; e.currentTarget.style.backgroundColor = 'rgba(255,255,255,0.22)'; }}
                onMouseLeave={e => { e.currentTarget.style.boxShadow = 'none'; e.currentTarget.style.backgroundColor = 'rgba(255,255,255,0.1)'; }}
        ...
        <div className="flex flex-col items-center justify-center h-full relative z-10">
          ...
          <p className="text-xs text-white/70 font-light text-center drop-shadow-sm px-8 py-1 rounded-full bg-white/5 backdrop-blur-sm">PNG, JPG, HEIC</p>
        </div>
      )}
    </motion.div>
  );
